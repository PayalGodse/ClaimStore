 ...
 * generated in the com.mitchell.examples.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.examples.mitchell.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.examples.mitchell.com/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mitchell.examples.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.examples.mitchell.com/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.examples.mitchell.com/", name = "helloWorldResponse")
