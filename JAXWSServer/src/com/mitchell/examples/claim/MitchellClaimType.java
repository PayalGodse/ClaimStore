...
@XmlType(name = "MitchellClaimType",namespace="", propOrder = {
	"id",
    "claimNumber",
    "claimantFirstName",
    "claimantLastName",
...
public class MitchellClaimType {
    ...
    protected int lossInfo;
    @XmlElement(name = "AssignedAdjusterID")
    protected String assignedAdjusterID;
     ...
     *     
     */
    public void setLossInfo(int value) {
        this.lossInfo = value;
    }
     ...
     *     
     */
    public void setAssignedAdjusterID(String value) {
